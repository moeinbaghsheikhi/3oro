...
const testimonials = [
  {
    ...
    quote: 'از وقتی از 30Ro استفاده می‌کنیم، مدیریت پرونده‌ها و ارتباط با موکلین بسیار ساده‌تر شده است. بهره‌وری دفتر ما به طور چشمگیری افزایش یافته!',
    stars: 5,
  },
  {
    ...
    quote: '30Ro به ما کمک کرده تا پروژه‌ها را بهتر مدیریت کنیم و گزارش‌های دقیقی از پیشرفت کار داشته باشیم. واقعا توصیه می‌کنم.',
    stars: 5,
  },
  {
    ...
    quote: 'ثبت‌نام دانش‌آموزان، برنامه‌ریزی کلاس‌ها و امور مالی آموزشگاه با 30Ro بسیار منظم و کارآمد شده است. تیم پشتیبانی هم عالی هستند.',
    stars: 4,
  },
];
    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle 
          ...
          subtitle="بشنوید از کسب‌وکارهایی که با کمک 30Ro به موفقیت‌های جدیدی دست یافته‌اند."
        />
